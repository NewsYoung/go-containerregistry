...
// https://github.com/NewsYoung/go-containerregistry/issues/377
...
func (e *ErrSchema1) Error() string {
	return fmt.Sprintf("unsupported MediaType: %q, see https://github.com/NewsYoung/go-containerregistry/issues/377", e.schema)
}
